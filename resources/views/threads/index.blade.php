    ...
    <div class="flex h-[calc(100vh-65px)] bg-gray-50">
        ...
        <main class="flex-1 overflow-y-auto bg-gray-50 relative scroll-smooth">
            <div class="max-w-5xl mx-auto px-6 py-10">
                ...
                {{-- Tab Navigasi Materi & Diskusi (Agar konsisten dengan halaman lesson) --}}
                <div class="mb-8 border-b border-gray-200">
                    <nav class="-mb-px flex space-x-8" aria-label="Tabs">
                        <a href="{{ route('courses.lesson.show', ['course' => $course, 'content' => $courseContents->first()]) }}" class="border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm flex items-center transition-colors">
