<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between">
            <div>
                <h2 class="font-bold text-2xl bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent leading-tight tracking-tight">
                    {{ __('Dashboard') }}
                </h2>
    ...
    <div class="py-12 bg-gradient-to-br from-blue-50 via-white to-blue-50">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-8">
            ...
            @if(auth()->user()->role === 'student')
                ...
                <div class="relative bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 rounded-3xl p-8 md:p-10 shadow-2xl overflow-hidden text-white">
                    ...
                    <div class="absolute top-1/2 left-1/3 w-32 h-32 bg-blue-300 opacity-10 rounded-full blur-2xl pointer-events-none"></div>
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
                        ...
                        <div class="hidden md:block">
                            <div class="p-4 bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl flex items-center gap-4 shadow-xl">
                                ...
                                <div class="h-12 w-12 bg-gradient-to-br from-yellow-400 to-yellow-500 rounded-full flex items-center justify-center text-yellow-800 shadow-lg shadow-yellow-500/50">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 md:hidden">
                    <div class="bg-gradient-to-br from-white to-blue-50 p-4 rounded-2xl shadow-lg border border-blue-100 text-center hover:shadow-xl transition-all">
                    ...
                    <div class="bg-gradient-to-br from-white to-green-50 p-4 rounded-2xl shadow-lg border border-green-100 text-center hover:shadow-xl transition-all">
                        <p class="text-xs text-gray-500 font-bold uppercase">Selesai</p>
                        <p class="text-2xl font-bold bg-gradient-to-r from-green-600 to-green-500 bg-clip-text text-transparent">{{ $completedCourses }}</p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    @if($enrolledCourses->isEmpty())
                        <div class="bg-gradient-to-br from-white via-blue-50/30 to-white rounded-3xl p-12 text-center border-2 border-dashed border-blue-200 shadow-lg">
                            <div class="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-blue-100 to-blue-200 text-blue-500 rounded-full mb-4 shadow-lg shadow-blue-500/20">
                                ...
                                <div class="bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 border border-blue-100 flex flex-col h-full group overflow-hidden hover:-translate-y-1">
                                    ...
                                    <div class="relative h-40 bg-gradient-to-br from-gray-200 to-gray-300 overflow-hidden">
                                        ...
                                        <div class="absolute bottom-3 left-4 right-4">
                                            <span class="inline-block px-2 py-1 rounded-md bg-gradient-to-r from-blue-500/80 to-blue-600/80 backdrop-blur-sm border border-white/30 text-white text-[10px] font-bold uppercase tracking-wide mb-1 shadow-lg">
                                                {{ $course->category->name ?? 'Umum' }}
                                            </span>
                                        </div>
                                    </div>

                                    <div class="p-5 flex flex-col flex-grow bg-gradient-to-br from-white to-blue-50/20">
                                        ...
                                        <div class="mt-auto">
                                            <div class="flex justify-between items-end mb-1">
                                                ...
                                                <span class="text-xs font-bold {{ $course->progress_percentage == 100 ? 'text-green-600' : 'bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent' }}">
                                                    {{ (int)$course->progress_percentage }}%
                                                </span>
                                            </div>
                                            <div class="w-full bg-gradient-to-r from-gray-100 to-gray-200 rounded-full h-2 mb-4 overflow-hidden shadow-inner">
                                                <div class="h-full rounded-full transition-all duration-1000 ease-out {{ $course->progress_percentage == 100 ? 'bg-gradient-to-r from-green-500 to-green-600' : 'bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600' }} shadow-lg" 
                                                     style="width: {{ $course->progress_percentage }}%"></div>
                                            </div>

                                            <div class="flex items-center gap-2">
                                                @if($course->progress_percentage == 100)
                                                    <a href="{{ route('courses.certificate', $course) }}" class="flex-1 inline-flex justify-center items-center px-4 py-2.5 bg-gradient-to-r from-green-50 to-emerald-50 text-green-700 border border-green-200 rounded-xl text-xs font-bold hover:from-green-100 hover:to-emerald-100 transition-all shadow-sm hover:shadow-md">
                                                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                                        Sertifikat
                                                    </a>
                                                    <a href="{{ route('courses.lesson.show', ['course' => $course, 'content' => $course->firstContent]) }}" class="px-3 py-2.5 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-600 rounded-xl hover:from-gray-200 hover:to-gray-300 transition-all shadow-sm" title="Review Materi">
            ...
            @elseif(auth()->user()->role === 'teacher')
                ...
                <div class="relative bg-gradient-to-r from-blue-600 via-blue-500 to-blue-600 rounded-3xl p-8 md:p-10 shadow-2xl overflow-hidden text-white mb-10">
                    <div class="absolute top-0 right-0 w-64 h-64 bg-white opacity-10 rounded-full blur-3xl -mr-16 -mt-16 pointer-events-none animate-pulse"></div>
                    <div class="absolute bottom-0 left-0 w-40 h-40 bg-blue-400 opacity-20 rounded-full blur-2xl -ml-10 -mb-10 pointer-events-none"></div>
                    <div class="absolute top-1/3 right-1/3 w-32 h-32 bg-blue-300 opacity-10 rounded-full blur-2xl pointer-events-none"></div>
                    ...
                    <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                        <div>
                            <div class="inline-flex items-center gap-2 mb-3 bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-md border border-white/20 px-3 py-1 rounded-lg shadow-lg">
                                <svg class="w-4 h-4 text-blue-200" fill="currentColor" viewBox="0 0 20 20"><path d="M10.394 2.08a1 1 0 00-.788 0l-7 3a1 1 0 000 1.84L5.25 8.051a.999.999 0 01.356-.257l4-1.714a1 1 0 11.788 1.838L7.667 9.088l1.94.831a1 1 0 00.787 0l7-3a1 1 0 000-1.838l-7-3zM3.31 9.397L5 10.12v4.102a8.969 8.969 0 00-1.05-.174 1 1 0 01-.89-.89 11.115 11.115 0 01.25-3.762zM9.3 16.573A9.026 9.026 0 007 14.935v-3.957l1.818.78a3 3 0 002.364 0l5.508-2.361a11.026 11.026 0 01.25 3.762 1 1 0 01-.89.89 8.968 8.968 0 00-5.35 2.524 1 1 0 01-1.4 0zM6 18a1 1 0 001-1v-2.065a8.935 8.935 0 00-2-.712V17a1 1 0 001 1z"></path></svg>
                                <span class="text-xs font-bold uppercase tracking-wider">Panel Pengajar</span>
                            </div>
                            <h1 class="text-3xl md:text-4xl font-extrabold mb-2 drop-shadow-lg">Halo, {{ explode(' ', Auth::user()->name)[0] }}! 👨‍🏫</h1>
                            <p class="text-blue-100 text-lg max-w-lg">Kelola kurikulum, pantau siswa, dan tingkatkan kualitas pembelajaran Anda di sini.</p>
                        </div>
                        ...
                        <div class="flex gap-4">
                            <div class="text-center p-5 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/20 rounded-2xl min-w-[110px] shadow-xl hover:scale-105 transition-transform">
                                ...
                                <p class="text-[10px] text-blue-200 uppercase font-bold tracking-widest mt-1">Total Siswa</p>
                            </div>
                            <div class="text-center p-5 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/20 rounded-2xl min-w-[110px] shadow-xl hover:scale-105 transition-transform">
                                <p class="text-3xl font-black drop-shadow-md">{{ $activeCourses }}</p>
                                <p class="text-[10px] text-blue-200 uppercase font-bold tracking-widest mt-1">Kelas Aktif</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    @if($taughtCourses->isEmpty())
                         <div class="bg-gradient-to-br from-white via-blue-50/30 to-white rounded-3xl p-12 text-center border-2 border-dashed border-blue-200 hover:border-blue-300 transition-all group shadow-lg">
                            <div class="inline-flex items-center justify-center w-24 h-24 bg-gradient-to-br from-blue-100 to-blue-200 text-blue-500 rounded-full mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg shadow-blue-500/20">
                    ...
                    @else
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            @foreach($taughtCourses as $course)
                                <div class="bg-white rounded-2xl shadow-md hover:shadow-2xl transition-all duration-300 border border-blue-100 flex flex-col h-full group overflow-hidden relative hover:-translate-y-1">
                                    ...
                                    <div class="relative h-40 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                                        ...
                                        <div class="absolute top-3 right-3">
                                            @if($course->is_active)
                                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg bg-gradient-to-r from-green-500 to-emerald-600 text-white text-[10px] font-bold uppercase tracking-wide backdrop-blur-sm shadow-lg border border-green-400/50">
                                                    <span class="w-1.5 h-1.5 bg-white rounded-full mr-1.5 animate-pulse"></span> Aktif
                                                </span>
                                            @else
                                                <span class="inline-flex items-center px-2.5 py-1 rounded-lg bg-gradient-to-r from-gray-700 to-gray-800 text-white text-[10px] font-bold uppercase tracking-wide backdrop-blur-sm shadow-lg border border-gray-600/50">
                                                    Draft
                                                </span>
                                            @endif
                                        </div>
                                        ...
                                        <div class="absolute bottom-3 left-4">
                                             <span class="text-[10px] font-bold text-white bg-gradient-to-r from-white/20 to-white/10 backdrop-blur-md px-2 py-0.5 rounded border border-white/30 uppercase tracking-wider shadow-lg">
                                                {{ $course->category->name ?? 'Umum' }}
                                             </span>
                                        </div>
                                    </div>

                                    <div class="p-6 flex flex-col flex-grow bg-gradient-to-br from-white to-blue-50/20">
                                        <h4 class="text-lg font-bold text-gray-900 leading-snug mb-3 line-clamp-2 group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:to-blue-500 group-hover:bg-clip-text group-hover:text-transparent transition-all">
                                            {{ $course->title }}
                                        </h4>
                                        ...
                                        <div class="flex items-center justify-between text-xs text-gray-500 mb-6 pt-2">
                                            <div class="flex items-center gap-1" title="Jumlah Siswa">
                                                <div class="p-1 bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg">
                                                    <svg class="w-3 h-3 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                                                </div>
            ...
            @else
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-gradient-to-br from-white to-blue-50 p-6 rounded-2xl shadow-lg border border-blue-100 flex items-center hover:shadow-xl transition-all hover:-translate-y-1 group">
                        <div class="p-3 bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600 rounded-xl mr-4 group-hover:scale-110 transition-transform shadow-md">
                            <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
                        </div>
                        <div>
                            <p class="text-gray-500 text-sm font-medium">Total Pengguna</p>
                            <h3 class="text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">{{ $stats['total_users'] }}</h3>
                        </div>
                    </div>
                     <div class="bg-gradient-to-br from-white to-blue-50 p-6 rounded-2xl shadow-lg border border-blue-100 flex items-center hover:shadow-xl transition-all hover:-translate-y-1 group">
                        <div class="p-3 bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600 rounded-xl mr-4 group-hover:scale-110 transition-transform shadow-md">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">{{ $stats['total_courses'] }}</h3>
                        </div>
                    </div>
                     <div class="bg-gradient-to-br from-white to-blue-50 p-6 rounded-2xl shadow-lg border border-blue-100 flex items-center hover:shadow-xl transition-all hover:-translate-y-1 group">
                        <div class="p-3 bg-gradient-to-br from-blue-100 to-blue-200 text-blue-600 rounded-xl mr-4 group-hover:scale-110 transition-transform shadow-md">
                        ...
                        <div>
                            ...
                            <h3 class="text-2xl font-bold bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">{{ $stats['total_categories'] }}</h3>
                        </div>
                    </div>
                </div>

                <div class="bg-gradient-to-br from-white to-blue-50/30 rounded-2xl shadow-lg border border-blue-100 p-8 mt-6 hover:shadow-xl transition-all">
                    <div class="flex items-center justify-between mb-6">
                    ...
                    <div class="space-y-4">
                        @foreach($recentUsers as $user)
                            <div class="flex items-center justify-between border-b border-blue-100/50 pb-3 last:border-0 hover:bg-blue-50/30 p-2 rounded-lg transition-all">
                                <div class="flex items-center gap-4">
                                    <div class="h-10 w-10 rounded-full flex items-center justify-center font-bold text-white text-sm shadow-lg
                                        {{ $user->role == 'admin' ? 'bg-gradient-to-br from-red-500 to-red-600' : ($user->role == 'teacher' ? 'bg-gradient-to-br from-blue-600 to-blue-500' : 'bg-gradient-to-br from-blue-500 to-blue-400') }}">
                                ...
                                <span class="text-xs px-2.5 py-1 rounded-full font-bold border shadow-sm
                                    {{ $user->role == 'admin' ? 'bg-gradient-to-r from-red-50 to-red-100 text-red-700 border-red-200' : ($user->role == 'teacher' ? 'bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 border-blue-200' : 'bg-gradient-to-r from-blue-50 to-blue-100 text-blue-600 border-blue-200') }}">
                                    {{ ucfirst($user->role) }}
                                </span>
                            </div>
                        @endforeach
