                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex items-center">
                            <a href="{{ route('homepage') }}" class="text-2xl font-extrabold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent tracking-tight hover:scale-105 transition-transform">
                                LMS-Cerdika
                            </a>
                        </div>
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="lg:col-span-2 space-y-8">
                            ...
                            <!-- Hero Card dengan Gradasi -->
                            <div class="bg-white rounded-3xl shadow-2xl border border-blue-100 p-8 overflow-hidden relative hover-lift">
                                <!-- Decorative Elements -->
                                <div class="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-blue-400/20 to-purple-400/20 rounded-full blur-3xl animate-float"></div>
                                <div class="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr from-indigo-400/20 to-blue-400/20 rounded-full blur-3xl" style="animation: float 8s ease-in-out infinite;"></div>
                                ...
                                <div class="relative z-10">
                                    ...
                                    <h1 class="mt-6 text-4xl md:text-5xl font-black bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 bg-clip-text text-transparent leading-normal pb-2">
                                        {{ $course->title }}
                                    </h1>
                                    <div class="flex flex-wrap items-center gap-6 mt-7">
                                        ...
                                        <div class="flex items-center group">
                                            <div class="p-2 bg-gradient-to-br from-purple-500 to-pink-600 rounded-xl mr-3 shadow-lg shadow-purple-500/30 group-hover:scale-110 transition-transform">
                            ...
                            <div class="bg-white rounded-3xl shadow-xl border border-blue-50 p-8 hover-lift">
                                <div class="flex items-center justify-between mb-8">
                                    ...
                                    <span class="px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-sm font-bold rounded-full shadow-lg shadow-blue-500/30">
                                ...
                                <div class="space-y-4">
                                    @forelse($course->contents as $index => $content)
                                        ...
                                        @if($isEnrolled)
                                            ...
                                            class="group flex items-center p-5 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-100 rounded-2xl hover:border-blue-400 hover:shadow-xl hover:shadow-blue-500/20 transition-all duration-300 cursor-pointer hover-lift">
                        ...
                        <div class="lg:col-span-1">
                            <div class="bg-white border-2 border-blue-100 rounded-3xl shadow-2xl p-8 sticky top-24 overflow-hidden relative">
                                ...
                                <div class="absolute bottom-0 left-0 w-24 h-24 bg-gradient-to-tr from-indigo-400/20 to-blue-400/20 rounded-full blur-2xl"></div>
                                
                                <div class="relative z-10">
                                    <div class="text-center mb-8">
                                        <div class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-500 to-indigo-600 text-white text-xs font-bold uppercase tracking-wider rounded-full mb-4 shadow-lg shadow-blue-500/30">
