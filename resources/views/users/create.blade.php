                        ...
                        <div class="p-6 bg-gray-50 rounded-xl border border-gray-100 mb-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input id="password" name="password" type="password" class="block w-full px-4 py-3 border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 transition-colors sm:text-sm" placeholder="Minimal 8 karakter" required>
                                </div>
                                <div>
                                    ...
                                    <input id="password_confirmation" name="password_confirmation" type="password" class="block w-full px-4 py-3 border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 transition-colors sm:text-sm" placeholder="Ulangi password" required>
                                </div>
                            </div>
                        </div>
