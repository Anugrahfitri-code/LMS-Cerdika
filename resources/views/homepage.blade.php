                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-blue-50 border-2 border-blue-100 rounded-3xl p-8 shadow-xl">
                        ...
                        <div class="mt-10 text-center">
                            ...
                            @else
                                <a href="{{ route('login', ['notice' => 'browse_all']) }}" class="inline-flex items-center gap-3 px-8 py-4 border-2 border-blue-600 text-blue-600 font-bold rounded-2xl hover:bg-blue-600 hover:text-white transition-all shadow-lg hover:shadow-xl hover:scale-105 transform">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path>
                                    </svg>
                                    Tampilkan semua kursus
