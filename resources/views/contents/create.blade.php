<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Tambah Materi Baru - ') }} {{ $course->title }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('courses.contents.store', $course) }}" method="POST">
                        ...
                        <div class="mt-4">
                            ...
                            <input id="order" name="order" type="number" class="block mt-1 w-full rounded-md shadow-sm border-gray-300" value="{{ old('order', 0) }}">
                        </div>
