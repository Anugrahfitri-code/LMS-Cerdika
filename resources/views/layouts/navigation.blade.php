<nav x-data="{ open: false, notifyOpen: false }" class="bg-white border-b border-gray-100 h-20 flex items-center z-30">
    ...
    <div class="w-full px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6 gap-4">
                ...
                <div class="relative">
                    <button @click="notifyOpen = !notifyOpen" @click.away="notifyOpen = false" class="p-2 rounded-full text-gray-400 hover:text-blue-600 hover:bg-blue-50 transition relative focus:outline-none">
                    ...
                    <div x-show="notifyOpen" 
                         ...
                         class="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg py-2 border border-gray-100 z-50"
                         style="display: none;">
                        
                        <div class="px-4 py-2 border-b border-gray-100">
                            <span class="text-xs font-bold text-gray-400 uppercase tracking-wider">Notifikasi Terbaru</span>
                        </div>

                        <a href="#" class="block px-4 py-3 hover:bg-blue-50 transition">
                            <p class="text-sm font-bold text-gray-800">Tugas Web Programming</p>
                            <p class="text-xs text-gray-500 mt-1">Deadline pengumpulan besok pukul 23:59.</p>
                        </a>

                        <a href="#" class="block px-4 py-3 hover:bg-blue-50 transition border-t border-gray-50">
                            <p class="text-sm font-bold text-gray-800">Sistem Maintenance</p>
                            <p class="text-xs text-gray-500 mt-1">Server akan down sementara jam 02:00.</p>
                        </a>
