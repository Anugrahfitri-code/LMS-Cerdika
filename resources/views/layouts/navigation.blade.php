    ...
    <div class="w-full px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16 items-center">
            ...
            <div class="flex items-center flex-1">
                ...
                <div class="hidden sm:flex items-center w-full max-w-md ml-4">
                    <div class="relative w-full">
                        ...
                        <input type="text" class="block w-full pl-10 pr-3 py-2 border border-gray-200 rounded-xl leading-5 bg-gray-50 text-gray-900 placeholder-gray-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-blue-100 focus:border-blue-400 transition duration-150 ease-in-out sm:text-sm" placeholder="Cari data, kursus, atau pengguna...">
                    </div>
                </div>
            </div>
